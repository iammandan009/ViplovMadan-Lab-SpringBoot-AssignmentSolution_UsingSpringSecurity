...
<body>
	<div class="container">
		...
		<a href="/SpringBootStudentApp/students/showFormForAdd"
			class="btn btn-primary btn-sm mb-3">Add Student</a> <a
			href="/SpringBootStudentApp/logout"
			...
			<tbody>
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td><a
							href="/SpringBootStudentApp/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm">Update</a> <a
							href="/SpringBootStudentApp/students/delete?studentId=${tempStudent.id}"
